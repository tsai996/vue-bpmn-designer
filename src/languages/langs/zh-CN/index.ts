export default {
  ui: {
    title: 'vue-bpmn-designer 流程设计器（Flowable 版）',
    labelPositionTop: '顶部标签',
    labelPositionLeft: '左侧标签',
    formSizeDefault: '默认',
    formSizeCompact: '迷你',
    switchLanguage: '切换语言',
    import: '导入',
    ...
    exitSimulation: '退出模拟',
    validation: '流程校验',
    enableValidation: '开启校验',
    disableValidation: '关闭校验',
    minimap: '小地图',
    expandMinimap: '展开地图',
    collapseMinimap: '收起地图',
    exitSimulationFirst: '请先退出模拟模式',
    anonymousProcess: '匿名流程',
    newProcess: '新建流程',
    basicSettings: '基础配置',
    otherSettings: '其他配置',
    general: '常规',
    ...
    name: '名称',
    executable: '可执行',
    enterNodeId: '请输入节点 ID',
    enterNodeName: '请输入节点名称',
    add: '添加',
    operation: '操作',
    cancel: '取消',
    confirm: '确定',
    confirmDeleteEvent: '您确定要删除该事件吗？',
    confirmDeleteProperty: '您确定要删除该属性吗？',
    confirmDeleteField: '您确定要删除该字段吗？',
    confirmDeleteDataObject: '您确定要删除该数据对象吗？',
    newMessageDefinition: '新增消息定义',
    newErrorDefinition: '新增错误定义',
    createField: '创建字段',
    createInput: '创建入参',
    createOutput: '创建出参',
    addVariable: '添加变量',
