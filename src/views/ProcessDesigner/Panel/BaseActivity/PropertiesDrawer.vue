...
const formRules = computed<FormRules>(() => ({
  ...
  name: [{ required: true, message: translateUi('请输入属性名'), trigger: 'blur' }],
  value: [{ required: true, message: translateUi('请输入属性值'), trigger: 'blur' }],
}))
...
<template>
  ...
  >
    ...
    >
      ...
      <el-form-item :label="$tu('属性名')" prop="name">
        <el-input v-model="cloned.name" :placeholder="$tu('请输入属性名')"></el-input>
      </el-form-item>
      <el-form-item :label="$tu('属性值')" prop="value">
        <el-input v-model="cloned.value" :placeholder="$tu('请输入属性值')"></el-input>
      </el-form-item>
    </el-form>
    <template #footer>
